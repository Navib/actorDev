    ...
    [
      {
        ...
        background: 'white',
        credit: 'Vincent Cotroneo, Writer of "The Damaged"'
      }, {
        quote: 'Precise',
        background: 'white',
        credit: ''
    ...
    [
      {
        ...
        quote: '"Justin is always energetic, always ON when working. Positive attitude from beginning to end and great work ethic."',
        background: 'white',
        credit: 'Fernando Martinez from Adorama NYC.'
      }, {
        quote: '"Justin Schilling is an incredible actor and has gone above and beyond contributing to the productions I have worked with him on.  He\'s witty, quick thinking, engaging, and most of all committed to the production.  You can always count on him to deliver a high quality, stellar performance."',
        background: 'white',
        credit: 'Max Phillips,Director & Writer of "Library of Mabel Jones"'
      }, {
        quote: 'Direct',
        background: 'white',
        credit: ''
